...
export const TAG_GROUPS: TagGroup[] = [
  ...
  },
  {
    ...
    tags: [
      "Café", "Bakery", "Restaurant", "Bar", "Rooftop", "Bookshop", "Library", "Museum", "Gallery",
      "Market", "Local store", "Popup", "Garden", "Park", "Beach", "Viewpoint", "Old town", "Village", "Street",
...
export const TAG_TRANSLATIONS: Translations = {
  ...
  Library:        { "zh-CN": "图书馆",    "zh-TW": "圖書館" },
  Museum:         { "zh-CN": "博物馆",    "zh-TW": "博物館" },
  Gallery:        { "zh-CN": "美术馆",    "zh-TW": "美術館" },
  Market:         { "zh-CN": "市场",      "zh-TW": "市場" },
  "Local store":  { "zh-CN": "本地小店",  "zh-TW": "在地小店" },
  Popup:          { "zh-CN": "快闪店",    "zh-TW": "快閃店" },
