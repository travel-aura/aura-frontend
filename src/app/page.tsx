    ...
    <div className="relative flex min-h-screen w-full flex-col bg-white">
      ...
      <div className="relative flex h-[54px] items-end justify-between px-6 pb-2">
          ...
          <div className="flex items-center gap-1.5 text-black">
            ...
            {/* Wifi */}
            <svg className="size-[14px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round">
            ...
            {/* Battery */}
            <svg className="h-[13px] w-[25px]" viewBox="0 0 25 13" fill="none" stroke="currentColor" strokeWidth={1.2}>
